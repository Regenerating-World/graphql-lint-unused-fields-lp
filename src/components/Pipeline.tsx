...
const Pipeline = () => {
  ...
  return (
    <section id="pipeline" className="py-32 bg-gradient-subtle">
                ...
                <div key={step.titleKey} className="flex flex-col items-center">
                  <Card className="w-full border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg group">
                    <CardHeader className="text-center pb-4">
                      <div
                        className={`mx-auto w-16 h-16 ${step.bgColor} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                      >
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden md:block absolute transform translate-x-[88px] translate-y-[60px] lg:translate-x-[120px]">
