// Perfect Audience Pixel configuration for SEO tracking
// Replace PERFECT_AUDIENCE_PIXEL_ID with your actual Perfect Audience Pixel ID

!function(e,t,n){if(!e.snaptr){var a=e.snaptr=function(){a.handleRequest?a.handleRequest.apply(a,arguments):a.queue.push(arguments)},a.queue=[];var s='script';r=t.createElement(s);r.async=!0;r.src=n;var u=t.getElementsByTagName(s)[0];u.parentNode.insertBefore(r,u);}}(window,document,'https://sc-static.net/scevent.min.js');

// Replace with your actual Perfect Audience Pixel ID
snaptr('init', 'PERFECT_AUDIENCE_PIXEL_ID', {
